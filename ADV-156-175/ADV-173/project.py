...
class parent():
    ...
    def doctor(doctor_name):
        ...
        label_selected_doctor['text'] = doctor_name + \
            " has been alloted to "+hospital_list[random_hospital]
    ...
    def softwareEngineer(it_professional_name):
        ...
        label_selected_IT["text"] = it_professional_name + \
            " has been alloted to "+IT_company_list[random_IT_company]
    ...
    def chemicalEngineer(chemical_engineer_name):
        ...
        company_list = ["Chemical Company 1", "Chemical Company 2",
                        "Chemical Company 3", "Chemical Company 4"]
        ...
        label_selected_chemical['text'] = chemical_engineer_name + \
            " has been alloted to "+company_list[random_company]
...
obj2 = child2()
obj3 = child3()
btn_doctor = Button(root, text="Show the hospital alloted",
                    command=obj1.getDoctor)
...
btn_chemical = Button(
    root, text="Show the chemical company alloted", command=obj3.getChemical)
